...
f_max = 0.5; % Frecuencia máxima en Hz
NumPeriods = 4; % Mantener el número de períodos
...
writematrix(prbs_sequence_positiva', 'prbs_sequence_positiva2.csv');
